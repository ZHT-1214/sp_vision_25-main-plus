...
private:
  ...
  double gate_yaw_noise_;
  double gate_pitch_noise_;
  double gate_distance_noise_ratio_;
  double gate_angle_noise_;
  double armor_height_diff_;
  double armor_radius_;
  bool stationary_target_;
  bool lock_stationary_center_;
